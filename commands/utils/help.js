...
module.exports = {
  ...
  runSlash: (client, interaction) => {
        ...
        noArgsEmbed.addFields([
          {
            name: `${
              categoryName[category]
                ? `${categoryName[category][interaction.locale] ? categoryName[category][interaction.locale] : categoryName[category]["default"]}`
    ...
    return interaction.reply(
      `\n\`\`\`makefile\n[Help: Command -> ${cmd.name}] ${cmd.ownerOnly ? "⚠️ Command reserved to bot owner ⚠️" : ""}\n\n${cmd.description}\n${
